...
import { Plus, Save, Image, Pencil, Trash2 } from "lucide-react";
import { useToast } from "../../../components/common/ToastProvider";
import Loader from "../../../components/common/Loader";
import CentralizedLoader from "../../../components/common/CentralizedLoader";
import type { PhotoGallery, PhotoGalleryFormData } from "./photoGalleryTypes";
...
export default function AddOrEditFormPage() {
  ...
  useEffect(() => {
    if (isEditing && galleryData) {
      ...
      setMainImagePreview(galleryData.mainImageUrl || null);
  ...
  }, [mainImagePreview, multipleImagesPreviews]);
  ...
  const validateForm = () => {
    ...
    if (!mainImagePreview) newErrors.mainImage = "Main image is required.";
    if (multipleImagesPreviews.length === 0) newErrors.multipleImages = "Please upload at least one additional image.";
  ...
  // Handle main file upload with validation
  const handleMainFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!isValidType) {
      setErrors(prev => ({
        ...prev,
        mainImage: "Please upload a valid image (PNG, JPG, JPEG, SVG, GIF or WEBP)."
      }));
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      showToast(
        isEditing ? "Photo gallery updated successfully!" : "Photo gallery added successfully!",
        "success"
      );

      // Navigate back to galleries list
      navigate("/all-photo-galleries");
    } catch (error) {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)]">
      <PageMeta
        title={isEditing ? "Edit Photo Gallery | Admin Dashboard" : "Add Photo Gallery | Admin Dashboard"}
        description={isEditing ? "Edit photo gallery details" : "Add new photo gallery to the system"}
      />

      <div className="flex-none">
        <PageBreadCrumbForForm
          pageTitle={isEditing ? "Edit Photo Gallery" : "Add New Photo Gallery"}
          btnLabel="Cancel"
          navigatePath="/all-photo-galleries"
        />
      </div>
        ...
        <div className="h-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 hover:scrollbar-thumb-gray-500 dark:scrollbar-thumb-gray-600 dark:hover:scrollbar-thumb-gray-500 rounded-xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03] p-6">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-1" ref={setErrorRef("mainImage")}>
                <div className="flex flex-col h-full">
                  <Label htmlFor="mainImage" className="text-left">
                  ...
                  <div className="flex gap-2 mt-2 justify-center items-center">
                    ...
                    <button
                      ...
                      aria-label="Upload or change main image"
                    >
                      <Pencil size={16} />
                    </button>
                  ...
                  {/* Error hint for main image field */}
                  {errors.mainImage && (
              ...
              <div className="lg:col-span-2" ref={setErrorRef("title")}>
                <Label htmlFor="title" className="text-left">Gallery Title <span className="text-error-500">*</span></Label>
                <Input
                  id="title"
