...
export default function TableForNotice({
  data,
  columns,
  page,
  rowsPerPage,
            ...
            <Table className="w-full table-auto border-collapse">
              ...
              <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                {data.map((notice, index) => (
                  <TableRow key={notice.id} className="hover:bg-gray-50 dark:hover:bg-white/[0.05]">
                    {showSrNo && (
                      <TableCell
                    ...
                    {columns.map((col) => {
                      ...
                      let cellContent = notice[col.key as keyof Notice] as string;
