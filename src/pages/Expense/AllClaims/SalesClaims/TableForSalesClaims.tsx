...
import type { SalesClaim, ClaimStatus } from "./salesClaimsType";
import { currencySymbols, statusColors } from "./salesClaimsType";
...
onDeleteClick: (claim: SalesClaim) => void;
onRestoreClick: (claim: SalesClaim) => void;
  isLoading: boolean;
};

export default function TableForSalesClaims({
  data,
  columns,
  page,
  rowsPerPage,
