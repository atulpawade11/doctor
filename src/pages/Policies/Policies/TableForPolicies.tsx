...
type TableForPoliciesProps = {
  ...
  showSrNo?: boolean;
  showActions?: boolean;
  onEdit: (item: Policy) => void;
  onDelete: (item: Policy) => void;
  onViewPdf: (item: Policy) => void;
  isLoading: boolean;
};

export default function TableForPolicies({
  data,
  columns,
  page,
  rowsPerPage,
                  ...
                  <TableRow key={policy.id} className="hover:bg-gray-50 dark:hover:bg-white/[0.05]">
                    ...
                    {columns.map((col) => {
                      ...
                      if (col.key === "createdAt") {
                        cellContent = formatDate(policy[col.key as keyof Policy] as string);
                        ...
                        cellContent = policy[col.key as keyof Policy] as string;
                      }
