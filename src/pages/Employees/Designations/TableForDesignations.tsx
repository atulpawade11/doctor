...
import type { Designation } from "./designationType";
...
type TableForDesignationsProps = {
  data: Designation[];
...
export default function TableForDesignations({
  data,
  columns,
  page,
  rowsPerPage,
            ...
            <Table className="w-full table-auto border-collapse">
              ...
              <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                {data.map((designation, index) => (
                  <TableRow key={designation.id} className="hover:bg-gray-50 dark:hover:bg-white/[0.05]">
                    {showSrNo && (
                    ...
                    {columns.map((col) => {
                      ...
                      return (
                        <TableCell key={col.key} className="px-4 py-3 text-gray-600 text-theme-sm dark:text-gray-400">
                          {designation[col.key as keyof Designation] as string}
                        </TableCell>
                      );
                    })}
